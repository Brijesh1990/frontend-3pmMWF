      ...
      <div className="row mt-4">
        ...
        <div className="col-md-6">
          ...
          <p className="text-muted mb-4">
            A classic Italian pizza topped with fresh tomato sauce, creamy
            mozzarella cheese, and fragrant basil leaves. Simple yet packed with
            flavors, baked in a traditional stone oven for that perfect crispy
            crust.
          </p>
          <div className="mb-4">
            ...
            <div className="d-flex align-items-center mt-2">
              <div className="quantity-control rounded border">
                <button className="btn" id="minus">
                  -
                </button>
                <span className="mx-3 fw-bold" id="qty">
                  1
                </span>
          ...
          <div className="d-flex gap-3">
            <button
              className="btn btn-swiggy btn-lg flex-grow-1 add-to-cart-btn"
          ...
          <div className="mt-5 p-3 bg-light rounded-3">
            <div className="d-flex align-items-center mb-2">
              <i className="fas fa-truck text-success me-3" />
              <span className="fw-semibold">
                Free delivery on orders over $30
              </span>
            </div>
            <div className="d-flex align-items-center">
              <i className="fas fa-clock text-orange me-3" />
