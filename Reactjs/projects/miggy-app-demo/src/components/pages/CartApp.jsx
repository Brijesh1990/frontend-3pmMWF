  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-lg-8">
        <div className="card border-0 shadow-sm p-4 rounded-4 mb-4">
          <div className="d-flex justify-content-between align-items-center mb-4">
            ...
            <a
              href="products.html"
              className="text-orange text-decoration-none small fw-bold"
            >
              + Add more items
            </a>
          </div>
          ...
          <div className="cart-item">
            <img
              src="https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?auto=format&fit=crop&w=100&h=100"
              alt="Pizza"
            />
        ...
        <div className="card border-0 shadow-sm p-4 rounded-4">
          ...
          <textarea
            ...
            rows={2}
            placeholder="e.g. Please ring the bell or leave it at the door..."
            defaultValue={""}
          />
        </div>
      </div>
      ...
      <div className="col-lg-4">
        <div
          className="card border-0 shadow-sm p-4 rounded-4 position-sticky"
          style={{ top: 100 }}
        >
          ...
          <a href="checkout.html" className="btn btn-swiggy btn-lg w-100">
            PROCEED TO CHECKOUT
          </a>
